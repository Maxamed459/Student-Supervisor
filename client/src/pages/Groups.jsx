...
function Groups() {
  ...
  const availableSupervisors = () =>
    supervisors.filter(
      (supervisor) => supervisor.user?.isActive !== false
    );
            ...
            <div className="student-form">
              ...
              <div className="form-section">
                ...
                <p className="form-section-hint">
                  All active students who are not already in an
                  active group are listed.
                </p>
          ...
          <div className="student-modal group-modal">
            <div className="modal-header">
              <div>
                ...
                <p>
                  {managingGroup.name} ({managingGroup.code}) — all
                  active supervisors
                </p>
              </div>
              <button
